...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    n = recur_layers - 1
    while n > 0:
        bn_rnn = GRU(units, activation='relu',
        return_sequences=True, implementation=2, 
        name='rnn_{}'.format(recur_layers - n))(bn_rnn)
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    conv_border_mode, units, output_dim=29, drop_rate = 0.5):
    ...
    bn_cnn = BatchNormalization(name='bn_conv_1d')(conv_1d)
    bn_cnn = Dropout(drop_rate)(bn_cnn)
    # Add Bidirectional with batch normalization
    rnn = GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='bidir_rnn')
    ...
    # Add Rnn
    simp_rnn = GRU(units, activation='relu',
        return_sequences=True, implementation=2, name='rnn_final')(bn_bidir_rnn)
    bn_rnn = BatchNormalization()(simp_rnn)
    time_dense = TimeDistributed(Dense(output_dim))(bn_rnn)
